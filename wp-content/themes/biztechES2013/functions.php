...
if ( function_exists('register_sidebar')) {	
	...
	register_sidebar(array(
		'name'				=> 'Feature',
		'id'				=> 'feature-sidebar',
		'description'   	=> 'Main Feature area under logo',
		'before_widget'	 	=> '<div>',
		'after_widget' 		=> '</div>',
		'before_title' 		=> '<h1>',
		'after_title' 		=> '</h1>'
	...
	register_sidebar(array(
		'name'				=> 'Address',
		'id'				=> 'address-sidebar',
		'description'   	=> 'Address area under main copy on home page',
		'before_widget'	 	=> '<div>',
		'after_widget' 		=> '</div>',
		'before_title' 		=> '<h1 class="hidetext">',
		'after_title' 		=> '</h1>'
	));	
	register_sidebar(array(
		'name'				=> 'Home Box Left',
		'id'				=> 'boxleft-sidebar',
		'description'   	=> 'Feature Box Left under main feature area',
		'before_widget'	 	=> '<div>',
		'after_widget' 		=> '</div>',
		'before_title' 		=> '<h1>',
		'after_title' 		=> '</h1>'
	...
	register_sidebar(array(
		'name'				=> 'Home Box Rgiht',
		'id'				=> 'boxright-sidebar',
		'description'   	=> 'Feature Box Right under main feature area',
		'before_widget'	 	=> '<div>',
		'after_widget' 		=> '</div>',
		'before_title' 		=> '<h1>',
		'after_title' 		=> '</h1>'
	...
	register_sidebar(array(
		...
		'description'   	=> 'Latest New widget area on all pages except home page',
		'before_widget'	 	=> '<div>',
		'after_widget' 		=> '</div>',
		'before_title' 		=> '<h1>',
		'after_title' 		=> '</h1>'
	...
	register_sidebar(array(
		...
		'description'   	=> 'Bottom widget area on all pages except home page this can be customised PER PAGE using the "Sidebar" panel on "Edit Page"',
		'before_widget'	 	=> '<div>',
		'after_widget' 		=> '</div>',
		'before_title' 		=> '<h1>',
		'after_title' 		=> '</h1>'
...
if ( function_exists( 'register_nav_menus' ) ) {
	register_nav_menus(
		array(
		  'main-menu' => 'Main Menu',
		  'footer-menu' => 'Footer Menu (add items in reverse order)'
		)
	);
}
...
function new_excerpt_more($more) {
	...
	if (!is_search()) {
		return " <a href=\"".get_permalink($post->ID)."\" rel=\"bookmark\">" . "&#8230;find out more" . "</a>";
	} else {
		return " ...";
	}
}
...
class SearchExcerpt {
    ...
    function highlight_excerpt($keys, $text) {
        ...
        $included = array();
        $length = 0;
        while ($length < 512 && count($workkeys)) {
        ...
        if (sizeof($ranges) == 0)
            return '<p>' . _jamul_truncate($text, 512) . '&nbsp;...</p>';
